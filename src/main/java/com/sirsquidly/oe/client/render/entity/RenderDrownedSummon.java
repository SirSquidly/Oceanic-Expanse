...
public class RenderDrownedSummon extends RenderLiving<EntityDrownedSummon>
{
	...
	public static final ResourceLocation DROWNED_SUMMON_TEXTURE = new ResourceLocation(Main.MOD_ID + ":textures/entities/zombie/drowned_shipmate.png");
	...
	public RenderDrownedSummon(RenderManager manager)
    {
        ...
        //if (ConfigHandler.entity.drowned.drownedGlowLayer) { this.addLayer(new LayerDrowned(this)); }
	...
	@Override
	protected void preRenderCallback(EntityDrownedSummon entity, float f)
	{
		float size = 0.9375F;
